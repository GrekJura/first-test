...
for (const simpson of simpsons){
    document.write(`<div>${simpson.name}-${simpson.surname}-${simpson.age}-${simpson.info}-${simpson.photo}   </div>`)
}
document.write("</div>");
 */
...
for (const product of products){
    ...
    document.write(`<div class="product-card">
        <h3 class="product-title">${product.title}TITLE,${product.price}PRICE </h3>
